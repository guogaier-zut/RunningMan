...
public class myadapter extends RecyclerView.Adapter<myadapter.MyViewHolder> {
    ...
    public myadapter(List<HomeItem> list, Context context) {
        this.list = list;
...
//        System.out.println(list.get(position));
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            imageView = itemView.findViewById(R.id.crush_image);
            textView = itemView.findViewById(R.id.crush_time);
            textView1 = itemView.findViewById(R.id.crush_info);
            textView2 = itemView.findViewById(R.id.crush_user);
            textView3 = itemView.findViewById(R.id.crush_phone);
            textView4 = itemView.findViewById(R.id.crush_address);
            textView5 = itemView.findViewById(R.id.crush_price);
            button1 = itemView.findViewById(R.id.receive);
            button2 = itemView.findViewById(R.id.connect);
...
//            Toast.makeText(context, "接单成功", Toast.LENGTH_LONG).show();
            //todo
            String id = HomeFragment.id;
//            System.out.println("worker_id:"+id);
//            String s = list.get(getAdapterPosition()).toString();
//            System.out.println(s);
            Order order = new Order(id,list.get(getAdapterPosition()),"0");
            System.out.println(order.toString());
            Network.SaveOrder(order, new Network.SaveOrderListener() {
                @Override
                public void onFailure(@NotNull Call call, @NotNull IOException e) {
                    Looper.prepare();
                    Toast.makeText(context,"接单失败，请稍后重试",Toast.LENGTH_LONG).show();
                    Looper.loop();
                }
...
//	用户已经授权过申请
    ...
    private CallToClient callToClient;

    /**
     * 设置监听
     * @param callToClient
     */
    public void setCallToClient(CallToClient callToClient) {
